...
import { waffoWebhookRoutes } from './routes/waffo';
import { predictionRoutes } from './routes/predictions';
import { userProfileRoutes, adminUserRoutes } from './routes/users';
...
app.route('/api/v1/webhooks', waffoWebhookRoutes);
app.route('/api/v1/users', userProfileRoutes);
